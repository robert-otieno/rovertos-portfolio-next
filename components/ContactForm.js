        ...
        <>
            ...
            <header className="p-8 grid grid-cols-1 md:grid-cols-2 gap-4 pt-10 lg:px-40 dark:bg-blue-900 min-h-screen overflow-hidden">
                ...
                <form onSubmit={handleSubmit} className="relative z-[1] rounded-lg shadow-xl flex flex-col px-8 py-8 bg-white dark:bg-blue-500">
                    ...
                    <input type="email" name="email" value={email} onChange={(e) => {setEmail(e.target.value); }} className="bg-transparent border-b py-2 pl-4 focus:outline-none focus:rounded-md focus:ring-1 ring-orange-500 font-light text-gray-500" /> {errors?.email && ( <p className="text-red-500 font-light">Email cannot be empty.</p> )}
                    ...
                    <input type="text" name="subject" value={subject} onChange={(e) => {setSubject(e.target.value); }} className="bg-transparent border-b py-2 pl-4 focus:outline-none focus:rounded-md focus:ring-1 ring-orange-500 font-light text-gray-500" /> {errors?.subject && ( <p className="text-red-500 font-light">Subject cannot be empty.</p> )}
                    ...
                    <textarea name="message" value={message} onChange={(e) => {     setMessage(e.target.value); }} className="bg-transparent border-b py-2 pl-4 focus:outline-none focus:rounded-md focus:ring-1 ring-orange-500 font-light text-gray-500" ></textarea>
                    {errors?.message && (<p className="text-red-500 font-light">Message body cannot be empty.</p>)}

                    <div className="flex flex-row items-center justify-start">
                        <button type="submit" className="px-6 mt-6 py-2 bg-[#130F49] text-gray-50 font-light rounded-md text-sm flex flex-row items-center">
                            {buttonText}
