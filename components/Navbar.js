    ...
    <div className="navbar">
      <nav className="navbar__nav">
        ...
        <div className="navbar__links">
          <a className="navbar__link" title="About page" onClick={() => router.push("/about")}>What I Do</a>
          <a className="navbar__link" title="Projects listing page" onClick={() => router.push("/projects")}>Projects</a>
          <a className="navbar__link__contact" onClick={() => router.push("/contact")} title="Contact page">Contact</a>
          <span className="vertical__divider">|</span>
          <a className="mr-3" href="https://github.com/robert-otieno" rel="noreferer noopener" target="_blank" title="GitHub">
          ...
          <a className="" href="https://www.linkedin.com/in/robert-otieno-9b2b42174/" rel="noreferer noopener" target="_blank" title="LinkedIn">
